    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Advanced AI-powered analysis for legal documents using Named Entity
          Recognition, Summarization, and Retrieval-Augmented Generation
        </p>
      </div>
      ...
      <Tabs defaultValue="upload" className="w-full">
        ...
        <TabsContent value="upload" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload a legal document to automatically perform Named Entity
          ...
          {analysisResults && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your document has been processed. View results in the tabs
                  above.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-muted rounded-lg">
                    <div className="text-2xl font-bold text-primary">
                      {analysisResults.text_stats?.word_count || 0}
                    </div>
        ...
        <TabsContent value="summary">
          <SummaryResults
            results={analysisResults?.summary_results}
